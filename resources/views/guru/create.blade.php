    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary">
                <h3 class="card-title"><i class="fas fa-user-plus"></i> Form Tambah Guru</h3>
            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="employment_detail" class="form-control @error('employment_detail') is-invalid @enderror" 
                                               value="{{ old('employment_detail') }}" placeholder="Contoh: Guru Tetap, Wali Kelas">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="rfid_uid" class="form-control @error('rfid_uid') is-invalid @enderror" 
                                                   value="{{ old('rfid_uid') }}" placeholder="Scan kartu RFID">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="fingerprint_id" class="form-control @error('fingerprint_id') is-invalid @enderror" 
                                               value="{{ old('fingerprint_id') }}" min="1" max="162" placeholder="Enroll fingerprint di device">
                            ...
                            <div class="card card-outline card-secondary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="hp" class="form-control @error('hp') is-invalid @enderror" value="{{ old('hp') }}">
                                        @error('hp')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
